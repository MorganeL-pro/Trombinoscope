...
const anecdotes = [
    ...
    "Le Web n'est pas l'Internet. Quand on parle de l'Internet il s'agit du réseau informatique qui permet de communiquer entre les ordinateurs. Le Web se sert de cette capacité de l'Internet à communiquer des informations pour le faire sous forme de pages et de liens au travers d'un navigateur.",
    "1989, frontière franco-suisse, Conseil Européen pour la Recherche nucléaire-CERN. L’informaticien britannique Tim Berners-Lee discute avec son supérieur d’une proposition «vague mais excitante». Le web est né !",
    "1993, Une imprimante aux origines de Linux. Richard Stallman travaille au MIT. Une imprimante qui ne fonctionne pas très bien et il décide de corriger le driver. Petit problème pour Stallman, le code source du driver n'est pas fourni. Pour lui c'est la goutte d'eau. il lance le projet GNU (acronyme de GNU is Not Unix).",
    "2005, les relations entre la communauté développant le noyau Linux et la société en charge du développement de BitKeeper furent rompues, et le statut de gratuité de l’outil fut révoqué. La communauté du développement de Linux (et plus particulièrement Linus Torvalds) a développé son propre outil en se basant sur l’utilisation de BitKeeper.",
